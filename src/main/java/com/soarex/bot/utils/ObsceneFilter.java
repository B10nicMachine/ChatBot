...
public class ObsceneFilter {
    ...
    private static String[] exceptions = new String[]{"help", "команда", "eun", "hup", "хел", "where", "махер", "bla", "блямс", "блямб", "ноябр", "мандат", "eup", "hyundai", "roup", "sound", "oun", "aube", "ibarg", "ebay", "eeb", "shuy", "cayenne", "ain", "oin", "uen", "uip", "oup", "боеп", "деепр", "хульс", "een", "ee6", "ein", "хулио", "ебэ", "перв", "eep", "ying", "laun", "чаепитие"};
